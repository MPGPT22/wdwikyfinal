...
@section('content')
        <div class="col-md-12">
          <h4 class="panel-title">Editing Skill</h4>
                {!! Form::open(['route' => ['skills.update', $item->id],'method' => 'PUT' , 'name' => 'form-wizard', 'class'=>'form-control-with-bg']) !!}
                {!! Form::token() !!}
                  <!-- begin wizard -->
                  <div id="wizard">
                    <!-- begin wizard-step -->
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-8 offset-md-2">
                              ...
                              <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-6">
                                  <input type="text" name="name" placeholder="Dual Slash" data-parsley-group="step-1" data-parsley-required="true" class="form-control" value="{{$item->name}}" />
                                </div>
                              </div>
                              <!-- end form-group -->
                              <!-- begin form-group -->
                                ...
                                <div class="col-md-6">
                                  <select name="scope" class="form-control" data-parsley-group="step-1" data-parsley-group="step-1" required>
                                    ...
                                    @foreach ($scope as $targets)
                                      <option value="{{$targets->name}}" @if ($item->scope == $targets->name) selected @endif>{{$targets->name}}</option>
                                    @endforeach
                                  </select>
                                </div>
                              </div>
