...
@section('content')
  <div class="col-md-12">
    <h4 class="panel-title">Creating New State</h4>
          {!! Form::open(['route' => 'states.store', 'name' => 'form-wizard', 'class'=>'form-control-with-bg']) !!}
          {!! Form::token() !!}
            <!-- begin wizard -->
            <div id="wizard">
              <!-- begin wizard-step -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group row m-b-10">
                          ...
                          <div class="col-md-6">
                            <input type="text" name="name" placeholder="Burning" data-parsley-group="step-1" data-parsley-required="true" class="form-control" />
                          </div>
                        </div>
                        <!-- end form-group -->
                        <!-- begin form-group -->
