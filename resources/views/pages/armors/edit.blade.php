                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group row m-b-10">
                          ...
                          <div class="col-md-6">
                            <input type="text" name="name" placeholder="Helmet of wisdom" data-parsley-group="step-1" data-parsley-required="true" class="form-control" value="{{$item->name}}" />
                          </div>
                        </div>
                        <!-- end form-group -->
                        <!-- begin form-group -->
                          ...
                          <div class="col-md-6">
                            <select name="type" class="form-control" data-parsley-group="step-1" data-parsley-group="step-1" required>
                              ...
                              @foreach ($type as $types)
                                <option value="{{$types->name}}" @if ($types->name == $item->type) selected @endif>{{$types->name}}</option>
                              @endforeach
                            </select>
                          </div>
                        </div>
                          ...
                          <div class="col-md-6">
                            <select name="equipment_type" class="form-control" data-parsley-group="step-1" data-parsley-group="step-1" required>
                              ...
                              @foreach ($equipment as $equipments)
                                <option value="{{$equipments->name}}" @if ($equipments->name == $item->equipmentType) selected @endif>{{$equipments->name}}</option>
                              @endforeach
                            </select>
                          </div>
                        </div>
