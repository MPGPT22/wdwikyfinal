...
@section('content')
  <div class="col-md-12">
    <h4 class="panel-title">Creating New Weapon</h4>
          {!! Form::open(['route' => 'weapons.store', 'name' => 'form-wizard', 'class'=>'form-control-with-bg']) !!}
          {!! Form::token() !!}
            <!-- begin wizard -->
            <div id="wizard">
              <!-- begin wizard-step -->
                ...
                <li class="col-md-6 col-sm-6 col-6">
                  <a href="#step-1">
                    ...
                    <span class="info text-ellipsis">
                      Basic Information
                      <small class="text-ellipsis">Name, Type, Image, Icon and Description</small>
                    </span>
                  </a>
                </li>
                <li class="col-md-6 col-sm-6 col-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group row m-b-10">
                          ...
                          <div class="col-md-6">
                            <input type="text" name="name" placeholder="Sword of Destruction" data-parsley-group="step-1" data-parsley-required="true" class="form-control" />
                          </div>
                        </div>
                        <!-- end form-group -->
                        <!-- begin form-group -->
